...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const setLanguage = (language: Language) => setState(p => ({ ...p, language }));
  ...
  return (
    <AppContext.Provider value={{
      ...
      upsertApplication, updateApplicationStatus, removeApplication,
      addCoachMessage, clearCoachMessages,
    }}>
      {children}
    </AppContext.Provider>
  );
